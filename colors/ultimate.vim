...
hi Normal		guifg=black			guibg=#D5D1B3 "#D4D3A4
...
"hi Search		gui=underline guifg=black	guibg=pink   "#FFFF66
"hi Search		gui=underline guifg=black	guibg=#8DEECD   "#FFFF66
hi Search		gui=underline guifg=black	guibg=yellow   "#FFFF66
"hi IncSearch	guifg=fg		guibg=bg
hi IncSearch	gui=underline guifg=black		guibg=cyan
"hi LineNr		guifg=darkgray	guibg=#C0BCA1
hi LineNr		guifg=#888888	guibg=#C0BCA1
hi title		gui=bold
